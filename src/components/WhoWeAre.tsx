          ...
          <div ref={socialRef} className="mt-12">
            ...
            <div className="flex items-center gap-4 border border-neutral-800 p-4 w-fit bg-neutral-950/40">
              <a
                ...
                className="social-icon p-2 border border-neutral-800 hover:border-brand-orange hover:bg-brand-orange/10 hover:text-brand-orange hover:shadow-[0_0_15px_rgba(255,85,0,0.3)] transition-all duration-300 text-off-white"
              >
                <Instagram size={20} />
              </a>
              <a
